...
<body>
	...
	<div class="home-nav-left">
		<div class="home-nav-left-content">
			<img alt="bank-logo" src="../Images/register.png" width="200px"
				height="200px">
			<h2>Register yourself with us for instant banking!</h2>
		</div>
	</div>
				...
				<form action="../register" method="POST">
					...
					<div class="form-group">
						<label for="password">Password</label> <input type="password" id="password"
							class="form-control" placeholder="Enter atleast 5 characters" name="password"
							 onblur="validatePassword()" maxlength="15" required>
					</div>
					<div class="form-group">
						<label for="name">Date of birth</label> <input
							type="date" class="form-control"
							placeholder="Enter Your D.O.B" name="dob"
